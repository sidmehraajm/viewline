...
:: Define core paths
set "VIEWLINE_SOURCE=D:/works/developments"

set "LIB_DIR=D:/works/developments/devkit/site-packages"
set "PYTHON=C:/Program Files/Python310/python.exe"
set "USD_PLUGIN_PATH=D:/works/developments/devkit/plug-ins/OpenUSD-26.05"

set "PATH=%PATH%;%USD_PLUGIN_PATH%/bin;%USD_PLUGIN_PATH%/lib"

:: Set PYTHONPATH using semicolons (;) as separators
:: set "PYTHONPATH=%LIB_DIR%/charset-normalizer/3.3.2;%LIB_DIR%/certifi/2024.2.2;%LIB_DIR%/idna/3.7;%LIB_DIR%/urllib3/2.2.1;%LIB_DIR%/requests/2.32.2;%LIB_DIR%/darkdetect/0.7.1;%LIB_DIR%/pyqtdarktheme/2.1.0;%LIB_DIR%/OpenImageIO/3.0.4.0;%LIB_DIR%/PySide6/6.9.0;%LIB_DIR%/shiboken6/6.9.0;%LIB_DIR%/PySide6-Essentials/6.9.0;%LIB_DIR%/PySide6-Addons/6.9.0;%LIB_DIR%/PyOpenGL/3.1.9;%LIB_DIR%/opencolorio/2.5.0;%LIB_DIR%/av/17.0.0;%LIB_DIR%/numpy/1.26.4;%LIB_DIR%/usd-core/24.5;D:/works/developments"
